...
### 第4步
- 在“选择视频”弹出窗口中，单击上传的视频进行选择。
     - 注：根据视频大小，视频可能需要一段时间才能在这里显示。
- 单击“确认”按钮，将视频插入到您的内容页面中。

![](/img/ulearning/teacher/prepare25.png)

### 第5步
- 在“添加字幕”弹出窗口中，单击“确认”按钮，将视频插入内容页面。
     - 注：您也可以在这里导入此视频的字幕，也可以在插入视频后导入。

![](/img/ulearning/teacher/prepare26.png)

- 插入的视频显示在内容区域中，您可以：
     - 在视频的左下角添加字幕或注释。
     - 使用视频播放器下方工具栏中的工具来编辑/删除视频，编辑/添加字幕等，甚至将练习题插入视频中。
