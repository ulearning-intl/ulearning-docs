...
To edit an administrative class, click the **Edit** link **[5]** for that class.

## Delete Administrative Class
To delete an administrative class, click the **Delete** link **[6]** for that class.

## View Class Roster
To view a list of students in an administrative class, click the **Roster** link **[7]** for that class.
